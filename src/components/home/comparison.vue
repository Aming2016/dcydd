    ...
    <div class="rentinglist">
      ...
      infinite-scroll-immediate-check="true">
            <li @click="onTap(item,index)" @touchstart="btnleft(item,index,$event)" @touchend="diversionbtn(item,index,$event)" v-for="(item,index) in list">
                ...
                <div class="classbox" :class="{class_1:moveleft==index}">
                   <div v-if="item.status=='0'">
                       <img src="../../imgs/home/weixuanz.png" v-show="item.number" alt="" @click.stop="imgbtn(item,index)">
                       <img src="../../imgs/home/xuanzhong.png" v-show="!item.number" alt="" @click.stop="imgonebtn(item,index)">
                    </div>
        ...
        <div id="div_btn" v-show="movekong">
            <span>最多可选三套进行对比</span>
            <div @click="contrastlistbtn">开始对比</div>
        </div>
    </div>
</template>
<script>
