...
(function(){
    ...
    Cluster.prototype.updateClusterMarker = function () {
       ...
       this._markers.forEach((item,i) => {
            this._clusterMarker.setText({
                name :this._markerClusterer._markers[0].myhtml, 
                value : this._markers.length+"套"
            });
        });
        // this._clusterMarker.setText({
        //     name :this._markerClusterer._markers[1].myhtml, 
        //     value : this._markers.length+"套"
        // });
